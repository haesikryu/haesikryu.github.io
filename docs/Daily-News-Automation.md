...
- **우선**: `GROQ_API_KEY`가 있으면 Groq (Llama 3.3 등) 사용.
- **폴백**: `GEMINI_API_KEY`, `OPENAI_API_KEY` 순으로 시도.
...
| `GROQ_API_KEY` | Groq API 키 (우선 사용, [console.groq.com](https://console.groq.com)) |
...
# API 키 설정 후 실행
export GROQ_API_KEY="your-key"   # 권장 (Groq). 또는 GEMINI_API_KEY / OPENAI_API_KEY
